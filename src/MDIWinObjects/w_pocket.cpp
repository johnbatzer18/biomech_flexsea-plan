...
int W_Pocket::getCommandCode() { return CMD_READ_ALL_RIGID; }
...
void W_Pocket::display(PocketDevice *devicePtr, int index)
{
	...
	ui->disp_an2->setText(QString::number(po->mn.analog[2]));
	ui->disp_an3->setText(QString::number(po->mn.analog[3]));
	...
	ui->disp_vg->setText(QString::number((float)po->re.vg/1000,'f',2));
